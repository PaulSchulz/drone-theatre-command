...
(defun dtc-line-parameter-s (x0 y0 x1 y1 x2 y2)
  "Calculates the scalar parameter 's' position along the line.
S indicates the position of the perpendicular foot from (X0, Y0) onto
the infinite line defined by (X1, Y1) and (X2, Y2). s=0 at (X1, Y1) and
s=1 at (X2, Y2). All inputs should be floats."
